  ...
  return (
    ...
    className={`flex h-14 items-center justify-center border-b-[1px]
      border-b-richblack-700
       ...
       ${ location.pathname === "/" ?
          "fixed w-screen z-[1000]  bg-blue-50" : "" }
      ...
      location.pathname === "/contact" || matchRoute("/catalog/:catalogName")
            ...
            "fixed w-screen z-[1000]  bg-gray-300" : "" }
         transition-all duration-200 `}
  >
    <div className= {`flex fixed ${
      location.pathname !== "/" ? "bg-gray-300" : "bg-blue-50"
      ...
      <div className="hidden items-center gap-x-4 md:flex">
        ...
        {token === null && (
          <Link to="/login">
            <button className="rounded-[8px] border border-richblack-700 bg-gray-300 px-[12px] py-[8px] text-richblack-100">
              Log in
            </button>
          </Link>
        )}
